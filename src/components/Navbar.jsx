        ...
        <div className="relative">
          ...
          <AnimatePresence>
            {dropdownOpen && (
              ...
              >
                <a href="#" onClick={() => setDropdownOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-purple-600/20 hover:text-white transition-colors text-sm group">
