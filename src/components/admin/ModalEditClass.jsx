...
function ModalEditClass({ cls, onClose, onSave }) {
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h2 className="text-white text-xl font-black">Editar Turma</h2>
              <p className="text-gray-500 text-sm">Atualize os dados da turma.</p>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 focus:border-purple-500/60 rounded-xl px-4 py-3 pl-10 text-white text-sm outline-none transition-colors"
                />
              </div>
            </div>
